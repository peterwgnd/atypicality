...
let attr_texts = {
  danceability: [
    ...
    `The <b>danceability</b> score is a measure of how suitable a song is to dance to. “Believe” is a real banger, so it’s a little surprising it wasn't rated 100 percent on this scale. However, it’s important to note that these scores don't come from kids on American Bandstand&#8202;—&#8202;they come from a computer. Danceability is calculated algorithmically using criteria like the tempo and the strength and regularity of the beat.`,
  ...
  energy: [
    ...
    `“Believe”, with its “<a target="_blank" rel="noopener" href="https://www.youtube.com/watch?v=Lxc2nCmZzrs">boots and pants</a>” techno beat and throbbing synths gets a very high energy score.`
  ],
  acousticness: [
    ...
    `Cher's extravagantly autotuned vocals&#8202;—&#8202;a famous and trendsetting feature of the song&#8202;—&#8202;aren't fooling anyone. Not even a computer. This song is zero percent acoustic.`
  ],
  liveness: [
    `<b>Liveness</b> is how likely the algorithm thinks it is that this song was recorded live. Again, the song’s heavy-handed production leads to a very low score on this metric.`
  ],
  speechiness: [
    `<b>Speechiness</b> is a measure of the amount of spoken-word (as opposed to singing) in the track. “Believe” gets a low score here, though not quite zero (perhaps because of the “I don’t need you anymore” section of the bridge, which has a somewhat speechy feel).`
  ],
  instrumentalness: [
    `<b>Instrumentalness</b> is the estimated likelihood that this is an instrumental track. “Believe,” with its prominent vocals throughout, gets a zero on this.`
  ],
  valence: [
